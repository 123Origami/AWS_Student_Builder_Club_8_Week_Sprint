...
| Credit/Debit card | AWS requires for identity verification | Any international card (Visa, Mastercard, Amex) |
...
| **What if I don't have a credit card?** | Debit cards work if they have international capability. M-Pesa Global or similar virtual cards may work. |
...
| Option | Choice |
|--------|--------|
| Virtual MFA device | ✅ Select this |
...
| Option | Choice |
|--------|--------|
| Use a template | ✅ Select this (easiest) |
| Template type | ✅ Select "Monthly cost budget" |
...
✅ Test complete. Your account works perfectly for Week 1.
...
This README is comprehensive enough that students can:
- Run it entirely on their own without live help
- Troubleshoot common errors without asking you
- Refer back to it weeks later when they forget steps

Want me to create the **week-01 lab-guide.md** next with the same level of detail?